...
| N-4 | Release/discovery/threat-model tightening | Ongoing | Keep `.profile.json`, family `bundle.profile.json`, `typed_discovery`, `protocol_alignment`, threat-model docs, and release manifests aligned as GTOS-native protocol surfaces land |
