...
func TestOpenlibComposedExamplesMetadataAndDiscovery(t *testing.T) {
	root := projectRoot(t)
	testCases := []struct {
		file         string
		contractName string
	...
	}{
		{
			...
			packageName:  "tolang.examples.openlib_composed.policy_sponsored_checkout",
		...
		},
		{
			...
			packageName:  "tolang.examples.openlib_composed.private_service_order",
		...
		},
		{
			...
			packageName:  "tolang.examples.openlib_composed.private_escrow_checkout",
		...
		},
		{
			...
			packageName:  "tolang.examples.openlib_composed.sponsored_private_escrow_checkout",
		...
		},
		{
			...
			packageName:  "tolang.examples.openlib_composed.private_dispute_escrow",
		...
		},
		{
			...
			packageName:  "tolang.examples.openlib_composed.regulated_private_checkout",
		...
		},
		{
			...
			packageName:  "tolang.examples.openlib_composed.treasury_disclosure_flow",
	...
	for _, tc := range testCases {
		t.Run(tc.contractName, func(t *testing.T) {
			sourcePath := filepath.Join(root, "examples", "openlib_composed", tc.file)
