...
func compileOpenlibComposition(t *testing.T, baseDir string, name string, src string) {
	t.Helper()
...
func TestAgentOpenlibControlPlaneCompositionCompiles(t *testing.T) {
...
`
	compileOpenlibComposition(t, baseDir, filepath.Join(baseDir, "control_plane_composition.tol"), src)
}

func TestAgentOpenlibExecutionPlaneCompositionCompiles(t *testing.T) {
	repoRoot, err := os.Getwd()
	if err != nil {
		t.Fatalf("getwd: %v", err)
	}
...
`
	compileOpenlibComposition(t, baseDir, filepath.Join(baseDir, "execution_plane_composition.tol"), src)
}

func TestAgentOpenlibMarketPlaneCompositionCompiles(t *testing.T) {
	repoRoot, err := os.Getwd()
	if err != nil {
		t.Fatalf("getwd: %v", err)
	}
...
`
	compileOpenlibComposition(t, baseDir, filepath.Join(baseDir, "market_plane_composition.tol"), src)
}
