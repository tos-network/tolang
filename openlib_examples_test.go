...
func TestOpenlibComposedExamplesCompile(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			file:         filepath.Join(repoRoot, "examples/openlib_composed/PolicySponsoredCheckout.tol"),
			contractName: "PolicySponsoredCheckout",
			functions:    []string{"preauthorize", "executeCheckout", "dailyRemaining", "receiptStatus"},
		},
		{
			file:         filepath.Join(repoRoot, "examples/openlib_composed/PrivateServiceOrder.tol"),
			contractName: "PrivateServiceOrder",
			functions:    []string{"ready", "settleReadyOrder", "customerVaultBalance", "routeReady", "serviceManifest"},
		},
		{
			file:         filepath.Join(repoRoot, "examples/openlib_composed/PrivateEscrowCheckout.tol"),
		...
		{
			file:         filepath.Join(repoRoot, "examples/openlib_composed/SponsoredPrivateEscrowCheckout.tol"),
		...
		{
			file:         filepath.Join(repoRoot, "examples/openlib_composed/PrivateDisputeEscrow.tol"),
		...
		{
			file:         filepath.Join(repoRoot, "examples/openlib_composed/RegulatedPrivateCheckout.tol"),
		...
		{
			file:         filepath.Join(repoRoot, "examples/openlib_composed/TreasuryDisclosureFlow.tol"),
